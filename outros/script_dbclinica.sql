...
CREATE TABLE `fisioterapeutas` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `crefito` int(11) NOT NULL,
  `data_inscricao` date NOT NULL,
  `nome` varchar(255) NOT NULL,
  `id_usuario` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_CREFITO` (`crefito`),
  UNIQUE KEY `UK_FISIOTERAPEUTA_NOME` (`nome`),
  UNIQUE KEY `UK_FISIOTERAPEUTA_USUARIO_ID` (`id_usuario`),
  CONSTRAINT `FK_FISIOTERAPEUTA_USUARIO_ID` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nutricionistas` (
  ...
  UNIQUE KEY `UK_NUTRICIONISTA_NOME` (`nome`),
  UNIQUE KEY `UK_NUTRICIONISTA_USUARIO_ID` (`id_usuario`),
  CONSTRAINT `FK_NUTRICIONISTA_USUARIO_ID` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pacientes` (
  ...
  CONSTRAINT `FK_PACIENTE_ENDERECO_ID` FOREIGN KEY (`id_endereco`) REFERENCES `enderecos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
#$2a$10$.Q.eETvVKb3LqdiCA.KX7.OMwB0PyTqi148D0OfB777rlmQ3RGvj6